...
class APIFunctions {
    ...
    func checkinternet() -> Int {
        ...
        var request = URLRequest(url: URL(string: url+"/api/")!,timeoutInterval: Double.infinity)
        ...
        let task = URLSession.shared.dataTask(with: request) { data, response, error in
          guard let data = data else {
            ...
            connectionstatus = (response as! HTTPURLResponse).statusCode
    ...
    func Register(user : userModel) -> Int{
        ...
        var request = URLRequest(url: URL(string: url+"/api/users")!,timeoutInterval: Double.infinity)
    ...
    func login(email: String , password: String) -> userModel {
        ...
        var request = URLRequest(url: URL(string: url+"/api/login/")!,timeoutInterval: Double.infinity)
        request.addValue("application/x-www-form-urlencoded", forHTTPHeaderField: "Content-Type")
    ...
    func updateProfile(_id : String, firstname: String, lastname: String, email: String, age: Int, phone: String, location: String, password: String, role : String) {
        ...
        var request = URLRequest(url: URL(string: url+"/api/users/"+_id)!,timeoutInterval: Double.infinity)
        request.addValue("application/x-www-form-urlencoded", forHTTPHeaderField: "Content-Type")
    ...
    func liveMatches() -> Array<liveMatchModel> {
        ...
        var request = URLRequest(url: URL(string: url+"/api/live/")!,timeoutInterval: Double.infinity)
        request.httpMethod = "GET"
        request.httpBody = postData
    ...
    func finduserbyid(id : String) -> userModel {
        ...
        var request = URLRequest(url: URL(string: url+"/api/users/"+id)!,timeoutInterval: Double.infinity)
        request.httpMethod = "GET"
        request.httpBody = postData
    ...
    func findbyemail(email : String) -> userModel {
        ...
        var request = URLRequest(url: URL(string: url+"/api/find/"+email)!,timeoutInterval: Double.infinity)
        request.httpMethod = "GET"
        request.httpBody = postData
