...
class MatchAPI {
    ...
    func addStade(name: String, capacity: Int, price: Float, location: String, phone: String, datetime: String) -> String{
        ...
        var request = URLRequest(url: URL(string: "http://"+url+":3000/api/stades/")!,timeoutInterval: Double.infinity)
    ...
    func stadeImage(id: String,photo: UIImage, completion: @escaping (_ error: Error?, _ success: Bool)->Void) {
        let link="http://"+url+":3000/api/stades/"+id
    ...
    func findmatchwithstadeid(stadeid: String)-> MatchModel {
        ...
        var request = URLRequest(url: URL(string: "http://"+url+":3000/api/match/"+stadeid)!,timeoutInterval: Double.infinity)
        request.httpMethod = "GET"
        request.httpBody = postData
    ...
    func canceljointeamA(userid: String, matchid: String) {
        ...
        var request = URLRequest(url: URL(string: "http://"+url+":3000/api/match/"+matchid)!,timeoutInterval: Double.infinity)
        request.addValue("application/x-www-form-urlencoded", forHTTPHeaderField: "Content-Type")
